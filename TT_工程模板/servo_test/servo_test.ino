...
{
    myservo.attach(4);
    for(int posDegrees = 0; posDegrees <= 140; posDegrees++) {
        myservo.write(posDegrees);
        delay(5);
    }

    for(int posDegrees = 140; posDegrees >= 0; posDegrees--) {
        myservo.write(posDegrees);
        delay(5);
    }
